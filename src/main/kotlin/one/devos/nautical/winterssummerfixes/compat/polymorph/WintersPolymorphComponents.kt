package one.devos.nautical.winterssummerfixes.compat.polymorph
...
class WintersPolymorphComponents : BlockComponentInitializer {
    override fun registerBlockComponentFactories(registry: BlockComponentFactoryRegistry) {
        registry.registerFor(ElectricFurnaceBlockEntity::class.java, PolymorphFabricComponents.BLOCK_ENTITY_RECIPE_DATA) {
